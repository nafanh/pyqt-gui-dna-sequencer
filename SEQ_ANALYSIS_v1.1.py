...
#fileName, _ = QtWidgets.QFileDialog.getOpenFileName(self, 'Single File', QtCore.QDir.rootPath() , '*.xlsm')
    ...
    def getMinHeight(self):
        ...
        try:
            ...
            df_global_peaks = all_peaks_filtered(self.df_all_filtered_peaks, min_height) #Creates global peaks above min height for use other methods


            pre_df_all_int_std_filter = int_std_filtered(self.df_all_filtered_peaks) #Local table in case someone runs
